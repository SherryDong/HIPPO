...
perl src/gene2fa_combine.pl $true_gene,$pseudo_gene $combine_ref_dir $ref_fa $ref_annot
muscle -in $combine_ref_dir/combine.fa -out $combine_ref_dir/combine.aln -clw
perl src/common_ref.pl $combine_ref_dir/combine.aln $true_gene $total_gene_num $combine_ref_dir/$true_gene.bed $combine_ref_dir/combine_mod.info $combine_ref_dir/combine_mod.fa $combine_ref_dir/combine_mod_region.bed
